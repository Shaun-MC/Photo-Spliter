...
import { Upload, Image as ImageIcon, Download, Clock, AlertCircle } from 'lucide-react';
            ...
            <main className="max-w-7xl mx-auto py-8 px-4">
                ...
                <div className="bg-gray-800 rounded-xl p-8 mb-12">
                    <div className="flex flex-col items-center justify-center">
                        <label
                            className={`w-full max-w-xl h-64 flex flex-col items-center justify-center border-2 border-dashed rounded-lg cursor-pointer transition-colors ${isDragging
